...
- (void)swipeableTableViewCell:(SWTableViewCell *)cell didTriggerLeftUtilityButtonWithGesture:(SWUtilityButtonTapGestureRecognizer*)gesture;
- (void)swipeableTableViewCell:(SWTableViewCell *)cell didTriggerRightUtilityButtonWithGesture:(SWUtilityButtonTapGestureRecognizer*)gesture;
//] Added by Stayp 2014/08/14
...
@property (nonatomic, weak) UIView *scrollViewContentView;    // Added by Stayp 2018/06/30
...
//[ Added by Stayp 2014/08/14
- (void)setLeftUtilityButtons:(NSArray *)rightUtilityButtons WithButtonWidth:(CGFloat)width;
